...
//        mCollapsingToolbarLayout.setTitleEnabled(false);
    ...
    private static class MyHandler extends Handler {
        ...
        private WeakReference<Main7Activity> mMainActivityWeakReference;

        public MyHandler(Main7Activity mainActivity) {
        ...
        public void handleMessage(Message msg) {
            ...
            Main7Activity mainActivity = mMainActivityWeakReference.get();
